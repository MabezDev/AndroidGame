...
public class SwipeListener extends Entity implements IScrollDetectorListener,IClickDetectorListener, IOnSceneTouchListener 
{
	...
	public SwipeListener(Engine eng,SceneManager menuScene, Activity act) {
	...
	protected void createMenuBoxes(int offsetX, int offsetY, int gap) {
		...
		for (int x = 0; x < columns.size(); x++) {
			...
			Sprite sprite = new Sprite(spriteX, spriteY, texture,this.eng.getVertexBufferObjectManager()) {
